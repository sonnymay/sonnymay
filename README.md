...
| [Whimsy Hollow](https://github.com/sonnymay/whimsy-hollow) | Cozy hidden-object game — 59 hand-painted scenes, 5 story cases, desktop-packaged | Phaser 3 · TypeScript · Tauri | [src](https://github.com/sonnymay/whimsy-hollow) |
| [Task Manager API](https://github.com/sonnymay/TasksManagerAPI) | Production-quality RESTful CRUD API with auto-generated Swagger docs | FastAPI · SQLAlchemy · PostgreSQL | [src](https://github.com/sonnymay/TasksManagerAPI) |
...
|---|---|---|
| [SupportOps](https://github.com/sonnymay/supportops) | Public FastAPI/React/Supabase app; PR #16 shipped reliability, mobile UX, and search/filter improvements; draft PR #17 adds shareable URL-persisted ticket/RMA filters and actionable dashboard queues with green CI and Vercel preview checks; latest main CI passing; issue #8 needs scope or closure reconciliation after related search work landed; other roadmap issues cover email intake, role-based auth, CSV export, SLA alerts, and demo data | [Demo](https://supportops.vercel.app) |
...
| [ToDoMon](https://github.com/sonnymay/todomon) | Public TypeScript/Capacitor App Store app; skippable onboarding, new cosmetics, game-economy fixes, and hardened pet-name persistence shipped; latest GitHub Pages deploy passing; no open issues; repository README still needs Markdown cleanup and a feature refresh | [App Store](https://apps.apple.com/app/id6776013029) |
...
![Activity Graph](https://ghchart.rshah.org/6c5ce7/sonnymay)
