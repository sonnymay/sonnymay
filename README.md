...
| [Task Manager API](https://github.com/sonnymay/TasksManagerAPI) | Public FastAPI CRUD API; latest CI passing on main; no live Swagger URL is listed yet; open roadmap issues for JWT auth, pagination/filtering, and task due dates/priority | [Source](https://github.com/sonnymay/TasksManagerAPI) |
