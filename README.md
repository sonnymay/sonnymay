...
|---|---|---|
| [SupportOps](https://github.com/sonnymay/supportops) | Public FastAPI/React/Supabase app; main CI passing; mergeable draft PR #16 has passing CI/Vercel checks for reliability, mobile UX, and search/filter work; issue #8 remains open while that work is unmerged; other roadmap issues cover email intake, role-based auth, CSV export, SLA alerts, and demo data | [Demo](https://supportops.vercel.app) |
