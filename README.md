...
|---|---|---|
| [SupportOps](https://github.com/sonnymay/supportops) | Public FastAPI/React/Supabase app; PRs #18/#19 shipped PostgREST filter-injection hardening with main CI passing; five overlapping green drafts #20–#24 cover the remaining AI-suggest path and should be consolidated; draft PR #17's dashboard/filter work remains green; issue #8 still needs reconciliation after related search work landed; roadmap issues cover email intake, role-based auth, CSV export, SLA alerts, and demo data | [Demo](https://supportops.vercel.app) |
